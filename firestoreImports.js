...
async function jsonToFirestore() {
	try {
		...
		await firestoreService.initializeApp(serviceAccount, firebaseConfig.authDomain)
...
// In order to preserve ids in data.json as ids in firestore
// use keyed object (id being the key) instead of array of records
